...
from cvpods.utils import comm, log_first_n, get_event_storage
from cvpods.layers.dynamic_conv import DynamicBottleneck, DynamicConv2D, DynamicScale
from cvpods.layers.dynamic_conv import get_module_running_cost
from cvpods.layers.fix_conv import Bottleneck, ScaleConv2d
...
class FCOSDynamicHead(nn.Module):
    """
    The head used in FCOS for object classification and box regression.
    It has two subnets for the two tasks, with a common structure but separate parameters.
    """
